    ...
    <div class="small-container">
        ...
        <div class="row-4">
            <div class="col-4">
                ...
                <a href="cardetail.php?id=13" class="btn">BOOK</a>
            </div>
            <div class="col-4">
                <img src="img/v2.jpg">
                <h4>Volvo XC60</h4>
                ...
                <a href="cardetail.php?id=14" class="btn">BOOK</a>
            </div>
            <div class="col-4">
                <img src="img/v3.jpg">
                <h4>Volvo XC90</h4>
                ...
                <a href="cardetail.php?id=15" class="btn">BOOK</a>
            </div>
            <div class="col-4">
                <img src="img/v4.jpg">
                <h4>Volvo s90</h4>
                ...
                <a href="cardetail.php?id=16" class="btn">BOOK</a>
            </div>
        </div>
