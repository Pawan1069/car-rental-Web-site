...
<body>
    ...
    <div class="small-container">
        ...
        <div class="row-4">
            <div class="col-4">
                <img src="img/rr.jpg">
                <h4>Land Rover Range Rover Evoque</h4>
                <div class="rating">
                ...
                <a href="cardetail.php?id=17" class="btn">BOOK</a>
            </div>
            <div class="col-4">
                <img src="img/rv.jpg">
                <h4>Land Rover Range Rover Velar</h4>
                <div class="rating">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <a href="cardetail.php?id=18" class="btn">BOOK</a>
            </div>
            <div class="col-4">
                <img src="img/rds.jpg">
                ...
                <a href="cardetail.php?id=19" class="btn">BOOK</a>
            </div>
            <div class="col-4">
                <img src="img/lrd.jpeg">
                ...
                <a href="cardetail.php?id=20" class="btn">BOOK</a>
            </div>
        </div>
